...
public class trywithmultipleresources {
    public static void main(String args[]){
        ...
        try(    // Using multiple resources
                FileOutputStream fileOutputStream =new FileOutputStream("D:\\Project\\Practise\\src\\javaNIO\\testin.txt");
                InputStream input = new FileInputStream("D:\\Project\\Practise\\src\\javaNIO\\testin.txt")){
